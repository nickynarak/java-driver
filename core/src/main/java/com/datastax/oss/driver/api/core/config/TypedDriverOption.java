 ...
 * option.
 *
 * <p>This type is solely intended for use with {@link OptionsMap} and {@link
 * DriverConfigLoader#fromMap(OptionsMap)}. The APIs used to read the configuration, such as {@link
 * DriverConfig} and {@link DriverExecutionProfile}, use the untyped {@link DriverOption}. This
 * distinction is mainly historical: ideally it would have been simpler to use {@link
 * TypedDriverOption} everywhere, but this can't be changed retroactively without breaking the API.
 *
 * @since 4.6.0
 */
